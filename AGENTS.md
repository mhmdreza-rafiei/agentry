...
|-------|-------------|-------------|
| `/enhance-prompt` | User asks to enhance, improve, rewrite, optimize, or clarify a prompt — or always-on is enabled. Preserves user contracts; attaches related skills + prompt summary | Opt-in (see below) |
